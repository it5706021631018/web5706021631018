...
<tr>
  <td> Enter Age  :</td>
    <td> <input type="radio" name="a1" value="">13-15</br>
      <input type="radio" name="a2" value="">16-18</br>
      <input type="radio" name="a3" value="">19-22</br>
           <input type="radio" name="a4" value="">23-60</br>
            <input type="radio" name="a5" value="">60ปีขึ้นไป</br>
      </td>
  </tr>
